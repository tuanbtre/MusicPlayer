...
public class SmartTabLayout extends HorizontalScrollView {
     ...
     */
    public TextView createDefaultTabView(CharSequence title) {
    ...
    private static class SimpleTabProvider implements TabProvider {
        ...
        public View createTabView(ViewGroup container, int position, PagerAdapter adapter) {
            ...
            if (tabTitleView != null) {
                ...
                tabTitleView.setTextSize(TypedValue.COMPLEX_UNIT_SP,((FragmentPagerItemAdapter)adapter).getSize(position));
            }
