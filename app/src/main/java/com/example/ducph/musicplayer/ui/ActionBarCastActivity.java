...
import com.example.ducph.musicplayer.ui.MyMusicScreen.MyMusicActivity;
            ...
            if (mItemToOpenWhenDrawerCloses >= 0) {
                ...
                switch (mItemToOpenWhenDrawerCloses) {
                    ...
                    case R.id.navigation_my_music:
                        activityClass = MyMusicActivity.class;
                        break;
                }
...
//        getFragmentManager().removeOnBackStackChangedListener(mBackStackChangedListener);
    ...
    private void populateDrawerItems(NavigationView navigationView) {
        ...
        } else if (MyMusicActivity.class.isAssignableFrom(getClass())) {
            navigationView.setCheckedItem(R.id.navigation_my_music);
        }
    }
