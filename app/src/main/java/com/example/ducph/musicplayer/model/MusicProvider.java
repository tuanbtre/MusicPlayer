...
import static com.example.ducph.musicplayer.utils.MediaIDHelper.MEDIA_ID_ALBUM;
import static com.example.ducph.musicplayer.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_ALBUM;
import static com.example.ducph.musicplayer.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static com.example.ducph.musicplayer.utils.MediaIDHelper.MEDIA_ID_ROOT;

import static com.example.ducph.musicplayer.utils.MediaIDHelper.createMediaID;
...
public class MusicProvider {
    ...
    private synchronized void buildListsByAlbum() {
        ...
        for (MutableMediaMetadata m : mMusicListById.values()) {
            ...
            String source = m.metadata.getString(MusicProviderSource.CUSTOM_METADATA_TRACK_SOURCE);
        ...
        mMusicListByAlbum = newMusicListByGenre;
    }
    ...
    public List<MediaBrowserCompat.MediaItem> getChildren(String mediaId, Resources resources) {
       ...
       /* if (MEDIA_ID_ROOT.equals(mediaId)) {
        ...
        } else*/ if (MEDIA_ID_MUSICS_BY_GENRE.equals(mediaId)||MEDIA_ID_ROOT.equals(mediaId)) {
            for (String genre : getGenres()) {
                if(!"songs".equalsIgnoreCase(genre))
            ...
            for (String album : getAlbums()) {
                    ...
                    mediaItems.add(createBrowsableMediaItemForAlbum(album,mMusicListByAlbum.get(album).size(), resources));
            }
    ...
    private MediaBrowserCompat.MediaItem createBrowsableMediaItemForRoot(Resources resources) {
        MediaDescriptionCompat description = new MediaDescriptionCompat.Builder()
                ...
                .setIconUri(Uri.parse("android.resource://" +
                        "com.example.ducph.musicplayer/drawable/ic_by_genre"))
                .build();
    ...
    private MediaBrowserCompat.MediaItem createBrowsableMediaItemForAlbum(String album,int count,
                                                                          Resources resources) {
        MediaDescriptionCompat description = new MediaDescriptionCompat.Builder()
                .setMediaId(createMediaID(null, MEDIA_ID_MUSICS_BY_ALBUM, album))
                .setTitle(album)
                .setSubtitle(resources.getString(
                        R.string.browse_musics_by_genre_subtitle, count+""))
                .build();
        return new MediaBrowserCompat.MediaItem(description,
                MediaBrowserCompat.MediaItem.FLAG_BROWSABLE);
    }
