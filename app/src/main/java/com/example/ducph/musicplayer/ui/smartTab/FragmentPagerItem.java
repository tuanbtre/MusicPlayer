...
public class FragmentPagerItem extends PagerItem {
    ...
    protected FragmentPagerItem(CharSequence title, float width, String className, Bundle extras) {
        super(title, width,DEFAULT_SIZE);
        mClassName = className;
        mExtras = extras;
    }
    protected FragmentPagerItem(CharSequence title, float width, String className, Bundle extras, int size) {
        super(title, width,size);
        mClassName = className;
        mExtras = extras;
    }
    ...
    public static FragmentPagerItem of(CharSequence title, Class<? extends Fragment> clazz, Bundle extras, int size) {
        return of(title, DEFAULT_WIDTH, clazz, extras,size);
    }
    ...
    public static FragmentPagerItem of(CharSequence title, float width, Class<? extends Fragment> clazz, Bundle extras, int size) {
        return new FragmentPagerItem(title, width, clazz.getName(), extras,size);
    }
