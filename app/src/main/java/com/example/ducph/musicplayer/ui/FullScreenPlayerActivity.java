...
import com.example.ducph.musicplayer.AlbumArtCache;
import com.example.ducph.musicplayer.MusicService;
...
import com.example.ducph.musicplayer.ui.smartTab.FullPlayerFragment;
...
public class FullScreenPlayerActivity extends ActionBarCastActivity {
    ...
    private final MediaControllerCompat.Callback mCallback = new MediaControllerCompat.Callback() {
        ...
        public void onMetadataChanged(MediaMetadataCompat metadata) {
            if (metadata != null) {
                ((FullPlayerFragment) adapter.getPage(0)).updateMediaDescription(metadata.getDescription(),metadata.getText(MediaMetadataCompat.METADATA_KEY_COMPILATION).toString());
                ((LyricFragment) adapter.getPage(1)).updateMediaDescription(metadata.getText(MediaMetadataCompat.METADATA_KEY_COMPILATION).toString());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewGroup.addView(LayoutInflater.from(this).inflate(R.layout.smarttab_menu, viewGroup, false));
        smartTabLayout = (SmartTabLayout) findViewById(R.id.viewpagercircletab);
        final FragmentPagerItems pages = new FragmentPagerItems(this);
        pages.add(FragmentPagerItem.of("", FullPlayerFragment.class,getIntent().getExtras()));
        pages.add(FragmentPagerItem.of("", LyricFragment.class,getIntent().getExtras()));
...
//        }
    ...
    private void updatePlaybackState(PlaybackStateCompat state) {
        ...
        if (getSupportMediaController() != null && getSupportMediaController().getExtras() != null) {
            ...
            ((FullPlayerFragment) adapter.getPage(0)).mLine3.setText(line3Text);
        }
        ...
        switch (state.getState()) {
            ...
            case PlaybackStateCompat.STATE_BUFFERING:
                ...
                ((FullPlayerFragment) adapter.getPage(0)).mLine3.setText(R.string.loading);
                stopSeekbarUpdate();
                break;
            default:
